...
const ui = {
  ...
  analysisCqtCurveConfig: document.getElementById('analysisCqtCurveConfig'),
  analysisCqtCurveModal: document.getElementById('analysisCqtCurveModal'),
  analysisCqtCurveCanvas: document.getElementById('analysisCqtCurveCanvas'),
  analysisCqtCurveClose: document.getElementById('analysisCqtCurveClose'),
  analysisCqtCurveReset: document.getElementById('analysisCqtCurveReset'),
...
const state = {
  ...
  analysisReanalyzePending: false,
  analysisNotes: [],
  ...
  analysisCqtCurvePoints: [],
  analysisCqtCurveDrag: null,
